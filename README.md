...
<img width="492" height="883" alt="Screenshot 2025-10-03 000520" src="https://github.com/user-attachments/assets/75a0d4b5-806e-4abc-8630-67bcdbad9c56" />

External style.css ini mengatur agar tampilan web terlihat lebih menarik, pada bagian body digunakan font keluarga Segoe UI dengan warna teks gelap (#222) dan latar belakang berwarna terang (#f7f7f9). Elemen header diberi latar belakang hitam keabu-abuan (#333) dengan teks putih, padding diatur agar ada ruang di sekelilingnya, serta teks diposisikan di tengah. Class .subtitle diberi warna aksen hijau keemasan (#f9d923), ukuran font lebih besar (1.3em), dan jarak atas 10px agar tampak menonjol di bawah header. Bagian nav diberi latar belakang gelap dengan padding tipis, sedangkan link di dalam nav memiliki warna hijau keemasan, huruf tebal, tanpa garis bawah, serta diberi efek transisi saat hover sehingga warnanya berubah menjadi putih. Container .container digunakan untuk membatasi lebar maksimal 900px, memberi margin otomatis agar konten berada di tengah, dan padding agar tampilan lebih rapi. Heading h1, h2, dan h3 diberi jarak bawah, khusus untuk h2 ditambahkan warna teks hijau keemasan serta garis bawah dengan border solid agar lebih menonjol. Terakhir, class .skills-list digunakan untuk menampilkan daftar skill dalam format fleksibel dengan tampilan flexbox, tanpa bullet list, jarak antar item 15px, dan mendukung wrap agar item tetap rapi meskipun melebar.


<img width="408" height="702" alt="Screenshot 2025-10-03 000533" src="https://github.com/user-attachments/assets/6a5b2c8f-7a19-4369-8155-492bc4a3742f" />

Class .period ditata dengan ukuran font lebih kecil (0.95em), warna abu-abu (#666), dan jarak bawah 8px agar teks periode lebih halus dan tidak dominan. Tag <a> (link) secara umum diberikan warna biru (#1450a3), tanpa garis bawah, namun pada kondisi hover diberi efek underline untuk menandai interaksi pengguna. Bagian footer diberi latar belakang gelap (#333), teks putih, rata tengah, padding atas bawah 15px, margin atas 40px, serta ukuran font kecil (0.95em) agar konsisten dengan gaya minimalis.
Terakhir, terdapat aturan media query @media (max-width: 600px) yang mengatur tampilan agar responsif pada layar kecil. Pada kondisi ini, .container diberi padding tambahan, daftar skill .skills-list ditampilkan secara kolom, dan nav .container juga diubah menjadi tata letak kolom dengan gap lebih kecil (10px). Dengan pengaturan ini, halaman web dapat menyesuaikan tampilan pada perangkat mobile agar tetap rapi dan mudah dibaca.
